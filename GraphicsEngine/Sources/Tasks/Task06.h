...
#include "my/MaterialCoolEarth.h"
...
public:
	...
	virtual void Init()
	{
		...
		// Camera
		{
			...
			pCameraObj->m_pTransform = new Transform( Vector3(0.0f, .5f,-1.5f),
				Vector3(19.0f, 0.0f, 0.0f));
		...
		// Object #1 - Earth
		{
            ...
            pObject1->m_pMaterial	= new MaterialCoolEarth();
